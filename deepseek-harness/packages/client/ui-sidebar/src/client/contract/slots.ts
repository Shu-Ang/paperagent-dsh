...
declare module '@deepseek-ai/dsh-client-ui-slots' {
  interface SlotMap {
    ...
    /** Additive primary navigation immediately below the New Session action. */
    'sidebar.primary.action': { kind: 'list'; scope: 'root'; owner: SidebarFooterActionOwnerProps }
    /**
...
export type SidebarRootComponentProps =
  ...
  & PropsRenderSlots<'sidebar.workspaces' | 'sidebar.primary.action' | 'sidebar.settings' | 'sidebar.footer.action'>
