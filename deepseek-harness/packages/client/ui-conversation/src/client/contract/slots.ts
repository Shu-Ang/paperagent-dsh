...
/** Optional providers of exact inline-code actions in finalized assistant prose. */
export interface ChatInlineCodeMentions {
  register(provider: import('../chat/inline-code-mentions.ts').ChatInlineCodeMentionProvider): () => void
  forClosing(owner: TurnTailOwnerProps): MarkdownFileMentions | undefined
}
...
declare module '@deepseek-ai/cordis' {
  interface Context {
    ...
    /** Exact-token inline-code action registry for independently composed chat features. */
    chatInlineCodeMentions: ChatInlineCodeMentions
  }
}
